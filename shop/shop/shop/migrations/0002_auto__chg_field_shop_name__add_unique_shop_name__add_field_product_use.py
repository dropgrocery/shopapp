...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('shop_shop', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32))
        # Adding unique constraint on 'Shop', fields ['name']
        db.create_unique('shop_shop', ['name'])

        # Adding field 'Product.user'
        db.add_column('shop_product', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Shop', fields ['name']
        db.delete_unique('shop_shop', ['name'])


        # Changing field 'Shop.name'
        db.alter_column('shop_shop', 'name', self.gf('django.db.models.fields.TextField')())
        # Deleting field 'Product.user'
        db.delete_column('shop_product', 'user_id')
