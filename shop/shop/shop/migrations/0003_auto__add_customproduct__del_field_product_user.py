...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('shop_customproduct', (
        ...
        db.send_create_signal('shop', ['CustomProduct'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('shop_customproduct')


        # User chose to not deal with backwards NULL issues for 'Product.user'
        raise RuntimeError("Cannot reverse this migration. 'Product.user' and its values cannot be restored.")
    ...
    models = {
        ...
        'shop.customproduct': {
            'Meta': {'object_name': 'CustomProduct', '_ormbases': ['shop.Product']},
